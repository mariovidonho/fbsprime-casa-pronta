  ...
  return (
    <section className="py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        {/* Benefits Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10 mb-16 lg:mb-24">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl p-6 lg:p-8 shadow-soft hover:shadow-medium transition-all duration-300 transform hover:-translate-y-2 animate-slide-up border border-primary/5"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-primary rounded-2xl flex items-center justify-center mb-4 lg:mb-6">
                <benefit.icon className="w-8 h-8 lg:w-10 lg:h-10 text-white" />
              </div>
              
              <h3 className="text-xl lg:text-2xl font-bold text-primary mb-3 lg:mb-4 tracking-tight">
                {benefit.title}
              </h3>
        ...
        <div className="text-center">
          <div className="bg-gradient-primary rounded-3xl p-8 lg:p-16 text-white relative overflow-hidden">
            {/* Geometric accent */}
            <div className="absolute top-4 right-4 lg:top-8 lg:right-8 w-20 h-20 lg:w-32 lg:h-32 border border-white/20 rounded-2xl transform rotate-12 opacity-50"></div>
            
            <h3 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 lg:mb-6 tracking-tight">
              Pronto para dar o próximo passo?
            </h3>
            <p className="text-lg sm:text-xl lg:text-2xl mb-8 lg:mb-12 opacity-90 font-light max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 lg:gap-6">
              <div className="bg-white/20 backdrop-blur-sm text-white px-4 lg:px-8 py-3 lg:py-4 rounded-2xl font-semibold text-base lg:text-lg border border-white/30">
                ⚡ Resposta em até 24h
              </div>
              <div className="bg-white/20 backdrop-blur-sm text-white px-4 lg:px-8 py-3 lg:py-4 rounded-2xl font-semibold text-base lg:text-lg border border-white/30">
                🎯 100% Personalizado
